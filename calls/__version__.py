...
__description__ = _(
    ...
    "support (Twilio, SignalWire, Telnyx, Sinch, Exotel), call logging, agent "
    "mapping, and company-level access control."
)
__icon__ = "assets/fontawesome/svgs/solid/phone.svg"

__1_11_0__ = _(
    "Initial release: multi-provider telephony (Twilio, SignalWire, Telnyx, Sinch, "
    "Exotel, Mock) with adapter factory; company enable/disable and role/user access "
